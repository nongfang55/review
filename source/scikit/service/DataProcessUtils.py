...
class DataProcessUtils:
    ...
    def contactFPS_ACData(projectName, filter_change_trigger=True):
        ...
        """按照时间分成小片"""
        DataProcessUtils.splitDataByMonth(filename=None, targetPath=projectConfig.getFPS_ACDataPath(),
                                          targetFileName=targetFileName, dateCol='pr_created_at',
                                          dataFrame=data)
    ...
    def contactSVM_CData(projectName, filter_change_trigger=False):
        ...
        """按照时间分成小片"""
        DataProcessUtils.splitDataByMonth(filename=None, targetPath=projectConfig.getSVM_CDataPath(),
                                          targetFileName=targetFileName, dateCol='pr_created_at',
                                          dataFrame=data)
    ...
    def contactCHREVData(projectName, filter_change_trigger=False):
        ...
        data_review = data_review[['number', 'created_at_x', 'node_id', 'user_login_y', 'created_at_y']].copy(deep=True)
        ...
        """按照时间分成小片"""
        DataProcessUtils.splitDataByMonth(filename=None, targetPath=projectConfig.getCHREVDataPath(),
                                          targetFileName=targetFileName, dateCol='pr_created_at',
                                          dataFrame=data)
    ...
    def contactXFData(projectName, filter_change_trigger=False):
        ...
        """按照时间分成小片"""
        DataProcessUtils.splitDataByMonth(filename=None, targetPath=projectConfig.getXFDataPath(),
                                          targetFileName=targetFileName, dateCol='pr_created_at',
                                          dataFrame=data)
    ...
    def contactRF_AData(projectName, filter_change_trigger=False):
        ...
        """按照时间分成小片"""
        DataProcessUtils.splitDataByMonth(filename=None, targetPath=projectConfig.getRF_ADataPath(),
                                          targetFileName=targetFileName, dateCol='pr_created_at',
                                          dataFrame=data)
