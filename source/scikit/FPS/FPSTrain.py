...
if __name__ == '__main__':
    ...
    trainDataPath = [projectConfig.getRootPath() + r'\data\train\FPS_akka_data_2019_9.tsv']

    testDataPath = projectConfig.getRootPath() + r'\data\train\FPS_akka_data_2019_10.tsv'
